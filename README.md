...
![https://github.com/Killeck/killeck.github.io/blob/main/images/HE/A10-1%20Situasjonsplan.pdf](https://github.com/Killeck/killeck.github.io/blob/main/images/HE/A20-H01%20Plan%201.%20Etasje.pdf)
...
- **Vegg**: OSB plater over Gips for støydemping
- **Tak**: Perferert gips for støydemping
- **Stikkontakter**: 4 (doble) + 1 (singel) + 1 RJ45
- **Bryter**: Dimmer
### For oss
- Gummi/treningsmatter til gulv
- Ribbevegg
- Speil
- Weights rack
...
### For Entrepeneurs
- **Gulv**: Parkett
- **Vegg**: Vegg mot Gym og Vaskerom (spon over gips/eller motsatt) for støydemping
- **Tak**: Perferert gips for støydemping
- **Stikkontakter**: 10 (doble) 3 (single takmontert sentrert over hver av vindu vest) + RJ45
- **Bryter**: Dimmer
- **Annet**: 
	- Innfelte gardinskinner for "hotel gardiner" 2 spor, i forbindelse med alle vindu.
	- Magnetisk punkt i tak ved stikk.
### For oss
...
- **Brunevarer**:
	- Vaskemaskin
	- Steketopp med integrert vifte
	- Stekeovn
	- Micro/stekeovns kombinasjon
	- Kjølehjørne
- **Annet**: 
...
- **Vegg**: Malingsklar <-- Hadde det vært ønskelig med Tapet her (har ikke noen spesielle preferanser)
- **Tak**: gips
...
### For Entrepeneurs
- **Gulv**: Parkett
- **Vegg**: Sponplater/ Gips (Maling/Tapet klar)
- **Tak**: Gips, 
...
### For Entrepeneurs
- **Gulv**: Teppe
- **Vegg**: sponplater klar til maling/tapet
- **Tak**: Gips
...
### For Entrepeneurs
- **Gulv**: Teppe
- **Vegg**: spon/gips male klart evt tapet
- **Tak**: gips/takplater (egnethet)
...
- **Vegg**: sponplate / Gips klar til maling / tapet
...
## Utvendig Bod
### For Entrepeneurs
- **Gulv**: Betong med fall og sentralt sluk må gå minst 20 cm opp fra gulv til vegg
- **Vegg**: OSB
- **Tak**: OSB
- **Stikkontakter**: 3 fas med enkel 220v stikk. + 6 (doble) vorav 1 utvendig på vegg.
...
#### **Kles-sjakt**
- [Laundry-Jet](https://www.laundry-jets.co.uk/)
