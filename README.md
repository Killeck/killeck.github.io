...
# Fasade skisser
Fasade skisser viser i 2D hvordan huset vil framstå. I første etasjen representerer skissen stripete paneler som skal forestiller fasadeplater. Det er ikke nødvendig at disse følger denne stripete strukturen eller design.
...
## Fasade Sør
Merk: Trappetårn skal dekkes med samme materialer/farge som fasadeplater i 1.etg
...
## Generelle elementer
- Alle vindu i vest og sør i følgende rom skal ha solskjerming.
	- Stue 1.etg
	- Stue 2.etg
	- Kjøkken
 	- Spisestue
...
## Gym
- **Gulv**: Betong med støvsperre (epoxy lignende)
...
## Stue
- **Vegg**: Vegg mot Gym og Vaskerom ekstra støydemping
- **Tak**: Perferert gips for støydemping
- **Stikkontakter**: RJ45, 10 (doble), 3 (enkle takmontert sentrert over hver av vindu vest) 
- **Bryter**: Dimmer
- **Annet**: 
	- Innfelte gardinskinner for "hotel gardiner" 2 spor, i forbindelse med alle vindu.
	- Magnetisk punkt i tak ved stikk.
 	- Nedfelt kant overgang tak vegg, for skjult ledstriper. 
...
- Plassering av VVBreder og Veske til vann varmepumpeenhet
